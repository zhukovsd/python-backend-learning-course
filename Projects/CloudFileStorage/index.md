...
- Знакомство с NoSQL хранилищем S3 для хранения файлов
...
В данном проекте впервые воспользуемся Docker для удобного запуска необходимых приложений - SQL базы, файлового хранилища MinIO.
...
- Django SessionMiddleware - сконфигурировать хранение сессий
- Деплой
