...
Также Celery работает в синхронном режиме, что имеет ряд недостатков при использовании с асинхронными фремворками типа FastApi:
...
- при работе с io задачами синхронный Celery может быть меннее производительным

Для решения данных проблем на в реальном проекте могут быть выбраны аналоги поддерживающие асинхронную работу - task-iq, Arq, AioTasks.
Однако Celery популярнее и требуется в вакансиях при трудоустройстве, а принцип работы данных инструментов довольно похож.
...
Celelry Worker приложение с smtplib.
